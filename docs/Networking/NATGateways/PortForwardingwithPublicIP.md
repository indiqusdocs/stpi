...
The following steps guide you through the process of navigating to your NAT Gateway, generating a new public IPv4 address, and verifying its successful addition and availability within the Ananta Cloud environment:
...
The following steps guide you through locating the unused public IP, accessing the port forwarding interface, and initiating the configuration of a new port forwarding rule using the Ananta Cloud Portal:
...
1. Login to pfsense:
      - Open a browser and navigate to `https://<pfSense-IP>` (for example `https://164.164.197.178`).
...
![pfsenseportforwarding](img/pfsenseportforwarding.png)

![pfsenseportforwarding1](img/pfsenseportforwarding1.png)
...
![apachedefaultpage](img/apachedefaultpage.png)
...
![twoportforwarding](img/twoportforwarding.png)
