...
1. **[Remote Access VPN](/docs/Guide/Networking/IPv4-basedNetworking/UsingRemoteAccessVPNwithVPC) -** To connect securely from your home or office to your VPC on Ananta Cloud. This is mainly used when you have a dynamic IP to connect to the internet, so a VPN connection cannot be pre-configured.
2. **[Site-to-Site VPN](/docs/Guide/Networking/IPv4-basedNetworking/ManagingVPNGatewaysandSite-to-SiteVPN) -** To connect a private static network to your VPC on Ananta Cloud using an IPSec tunnel. Site-to-site gateways must be pre-configured on Ananta Cloud.
