...
To view the Networks associated with a Linux Instance, navigate to **Compute > 
Windows Instances** and access the **Networking** tab. The **Networking** tab lists all the networks that a Linux Instance is attached to, with the following details:
...
1. Click the **Add Network** button. The following screen appears: ![Secondary IP](img/AddingNetwork.png)
