...
3. Click the **Stop Instance** button. The following screen appears:![Stopping Instance](img/stoppinginstance.png)
4. Click the **Yes** button. The following screen appears:   ![Starting Instance](img/StartInstance.png)
