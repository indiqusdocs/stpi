...
3. Click **Volumes**. The following screen appears:![Volume](img/Volume1.png)
...
2. Click on your created Linux instance name from the list.
3. Click **Volumes**. The following screen appears: ![Volume](img/Volume1.png)
4. Click the **Add Volume** button to initiate the add volume procedure.
...
13. Select the **I have read and agreed to the Ananta Cloud Terms and Conditions and Privacy Policy** option, and click **Buy Monthly** button. The following screen appears:
