...
You can connect to Linux Instances via SSH sessions using passwords (less secure) or [SSH key pairs](/docs/Guide/ToolsandUtilities/ManagingSSHKeysandKeyPairs) (most secure)
