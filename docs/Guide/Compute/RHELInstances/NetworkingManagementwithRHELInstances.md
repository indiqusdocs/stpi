...
This section explains how to manage the network settings of your RHEL instances. You can add a network to connect an instance to a virtual network and assign secondary IP addresses to enable multiple network connections on the same instance. This helps you configure and manage your networking requirements more efficiently. 
...
To view the Networks associated with a RHEL Instance, navigate to **Compute > RHEL Instances** and access the **Networking** tab. The **Networking** tab lists all the networks that a RHEL Instance is attached to, with the following details:
...
- IPv6 Gateway
- IPv6 CIDR  
![linuxnetwork](img/RHELNetworking.png)
...
1. Click the **Add Network** button. The following screen appears: ![Networking ](img/AddNetwork1.png)
