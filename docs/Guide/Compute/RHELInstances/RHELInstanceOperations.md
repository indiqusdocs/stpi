...
To view all available Instance operations, navigate to **Compute > RHEL Instances**, click the RHEL Instance Name, and access the **Operations** tab.
...
- **Delete Instance**: Type DELETE in the provided field, and click the Schedule Deletion or Delete Now button based on your requirements.
  ...
  :::
![Deleting Instance](img/DeleteInstance.png)
