...
Navigate to **Compute > RHEL Instance**, click the particular **RHEL Instance Name,** and access the **Alerts** tab.
![RHEL Instance](img/NewRHELInstance.png)

# Instance Alerts

The Alerts tab lists all the alerts already configured for that particular RHEL Instance. In addition, it will show the following details:
...
![Created Alert](img/CreatedAlert.png)

# Creating an Alert

To create an alert, follow these steps:

1. Click the **Create Alert** button. The following screen appears: ![Creating Alert](img/CreatingAlert.png)
