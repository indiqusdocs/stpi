...
- The Cloud Console dashboard is always accessible in one click (by clicking on **Dashboard** while in the cloud management view, or by 'closing' the [Account Centre](/docs/Guide/AccountCentre/AboutAnantaAccountCentre) view). This ensures that it's always easy to restart an experience.
