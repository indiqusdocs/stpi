...
1. Navigate to **Billing > Wallet & Transactions**. ![# Wallet and Transactions](img/WalletandTransactions2.png)
2. Under the **Service Balance** section, enter the amount to pay, and click the **Pay Now** button. 
3. Select the desired online payment method: UPI, Cards, and Netbanking. Using this feature, you can specify the amount and also distribute the amount against outstanding invoices or settle it as advance amounts.![Online Payments](img/echallan1.png)
...
1. Navigate to **Billing > Wallet & Transactions**. ![# Wallet and Transactions](img/WalletandTransactions2.png)
2. Then, under the **Service Balance** section, enter the amount to pay, and click the **Pay Now** button. ![Online Payments](img/echallan1.png)
3. Click **Bank transfer**. The following screen appears:![Bank Transfer](img/echallan2.png)
