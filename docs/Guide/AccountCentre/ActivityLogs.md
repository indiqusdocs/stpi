...
2. Navigate to **Account Centre > Account**. The following screen appears:
	![Profile details](img/ActivityLogs1.png)
3. Click **Activity Logs**. The following screen appears:
   ![Activity Logs](img/ActivityLogs2.png)
