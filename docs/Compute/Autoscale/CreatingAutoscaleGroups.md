...
1. Go to the **Compute > Autoscale Groups** in the navigation menu.   ![Creating Autoscale Groups](img/CreatingAutoscaleGroups1.png)
...
6. Choose an **OS Image** to run on your Instance.![Autoscale Group](img/CreatingAutoscaleGroups2.png)
