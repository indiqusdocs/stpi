...
To view the available graphs and monitor the instance in real time, navigate to a Linux instance from [Linux Instances Screen](AboutLinuxInstances.md) and access the **Graphs** tab.
...
From [Linux Instances Screen](AboutLinuxInstances.md), navigate into a Linux Instance, and access the **Utilisation** tab to view historical usage across supported parameters.  
